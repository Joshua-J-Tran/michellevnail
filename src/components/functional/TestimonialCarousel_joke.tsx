...
import { testimonialsData_joke } from "./testimonialData_joke";
...
export default function TestimonialCarousel_Joke() {
  const [index, setIndex] = useState(0);
  const [testimonials, setTestimonials] = useState<Testimonial[]>([]);

  useEffect(() => {
    setTestimonials(shuffleArray(testimonialsData_joke as Testimonial[]));
  }, []);
