...
export default function ServiceList() {
  ...
  return (
    <div className="p-6 sm:p-10 flex flex-col items-center">
      <h2 className="text-6xl font-bold mb-8 text-center text-secondary">
        𓆰Our Services
      </h2>
      <p className="text-secondary/90 mb-6 sm:mb-8 text-center text-xl sm:text-2xl max-w-2xl text-secondary">
          ...
          >
            ...
            <div className="relative bg-near-black/95 rounded-[calc(0.75rem-3px)] overflow-hidden h-full flex flex-col">
              ...
              <div className="p-4 text-center relative">
                ...
                <h1 className=" text-secondary font-bold text-lg py-2 mt-2 rounded">
                  {service.name}
                </h1>
              </div>
            </div>
          ...
          >
            ...
            <div className="overflow-y-auto max-h-[80vh] pr-2">
              <button
                ...
                className="absolute top-2 right-3 text-secondary hover:text-red-300 text-2xl"
              >
                ✕
              </button>
              <h2 className="text-3xl font-bold mb-8 text-center text-secondary drop-shadow-lg">
              ...
              <ul className="space-y-3">
                {selectedService.options.map((option, index) => (
                  <li
                    key={index}
                    className="flex justify-between text-lg border-b border-white/30 pb-2 text-secondary/90"
                  >
